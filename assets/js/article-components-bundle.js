// Article Components Bundle
// Convenience script that loads all article components in correct order
// Usage: <script src="assets/js/article-components-bundle.js"></script>

(function() {
    'use strict';
    
    const scripts = [
        'components/article/breadcrumb.js',
        'components/article/author.js',
        'components/article/date.js',
        'components/article/article-header.js',
    ...
    function getBasePath() {
        ...
        if (currentScript && currentScript.src) {
            ...
            const match = scriptPath.match(/(.*\/)article-components-bundle\.js/);
            if (match) {
                return match[1];
            }
        }
