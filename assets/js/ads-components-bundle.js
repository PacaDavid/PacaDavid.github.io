// Ad Components Bundle
// Convenience script that loads all ad components in correct order
// Usage: <script src="assets/js/ads-components-bundle.js"></script>

(function() {
    'use strict';
    
    const scripts = [
        'components/ads/ad-type-a.js',
        'components/ads/ad-type-b.js',
        'components/ads/ad-components.js'
    ];
    ...
    function getBasePath() {
        ...
        if (currentScript && currentScript.src) {
            ...
            const match = scriptPath.match(/(.*\/)ads-components-bundle\.js/);
            if (match) {
                return match[1];
            }
        }
    ...
    function loadScriptsSequentially(index) {
        if (index >= scripts.length) {
            ...
            window.dispatchEvent(new CustomEvent('adsComponentsLoaded'));
            return;
        }
